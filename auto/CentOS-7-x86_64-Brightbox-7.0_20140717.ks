...
# Select Repos
repo --name="repo0" --mirrorlist="http://mirrorlist.centos.org/?release=$releasever&arch=$basearch&country=gb&repo=os"
repo --name="repo1" --mirrorlist="http://mirrorlist.centos.org/?release=$releasever&arch=$basearch&country=gb&repo=updates"
#repo --name="repo0" --baseurl=http://mirrors.kernel.org/centos/$releasever/os/$basearch
#repo --name="repo1" --baseurl=http://mirrors.kernel.org/centos/$releasever/updates/$basearch
repo --name="repo2" --mirrorlist="http://mirrors.fedoraproject.org/mirrorlist?repo=epel-$releasever&arch=$basearch&country=gb"
...
part / --fstype="xfs" --size=500 --grow --maxsize=2000 --asprimary
